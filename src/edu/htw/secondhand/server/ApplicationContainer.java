package edu.htw.secondhand.server;
...
import edu.htw.secondhand.util.Copyright;
...
public class ApplicationContainer {
	...
	static public void main (final String[] args) throws IllegalArgumentException, NotDirectoryException, NoSuchFileException, IOException, ClassNotFoundException {
		...
		final ResourceConfig configuration = new ResourceConfig().register(RestJpaLifecycleProvider.open("secondhand"));
		...
		try {
			...
			System.out.format("Bookmark %s%s/WEB-INF/shop.html for application access.\n", origin, internalFileHandler.getContextPath());
